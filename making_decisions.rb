...
if door == '1'
	...
	if bear == '1'
		puts 'The bear eats your face off. Good job noob!'
	elsif bear == '2'
		puts 'The bear eats your legs off. Good job noob!'
	else
	...
	puts 'You stumble around and fall on a knife and die. Good job noob!'
end